  ...
  const replaceSchema = (schema2) => coerce ? (0, import_replace_schema.replaceSchemaTypeFromManyOptions)(schema2, [
    ...
    if (import_typebox.Kind in schema2)
      if (schema2[import_typebox.Kind] === "Import")
        hasRef(schema2.$defs[schema2.$ref]) || (schema2 = schema2.$defs[schema2.$ref], (coerce || hasAdditionalCoerce) && (schema2 = replaceSchema(schema2), "$id" in schema2 && !schema2.$defs && (schema2.$id = `${schema2.$id}_coerced_${(0, import_utils.randomId)()}`)));
